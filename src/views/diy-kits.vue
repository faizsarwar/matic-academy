            ...
            <div class="row mt-2 mb-4 ml-4 mr-3 text-left">
                ...
                <div class="col-lg">
                    ...
                    <div style="background-color:#A2469A" class="pb-5  pl-5 pr-5 pt-0 disc">
                        ...
                        <p class="ml-4 pr-5 mt-5" style="color:white !important">The Arduino Starter Kit is a DIY kit aimed at tinkerers who want to dive into the world of technology. This kit will enable you to create cool projects such as Security system, Alarm system and many more based on your liking!
                        </p>
