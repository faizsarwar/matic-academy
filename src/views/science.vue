<template>
    ...
    <section class="pb-1" style="background-color: #A2469A;color:white">
      <div class="row mt-2 mb-4  text-left">
        <div class="col-lg ml-4 mr-3 pt-5">

          <div class="d-flex">
          <h1 class="ml-4 pr-5 mr-auto pt-5 mb-3"><b style="color:white !important">Online Science
            Classes For Kids
            </b>
          </h1>
    ...
    <section class="pt-5 pb-5 pl-4 pr-4 mb-5 text-center">
        <div>
            <h1 class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-4 mt-4"><b >Where Kids Become Scientists.</b></h1>
    ...
    <section class="p-5">
        <h1><b> Find an online Science Class that fits your schedule & needs</b></h1>
