            ...
            <div class="card" >
              <div class="card-body seller-Card" style="overflow-x :hidden">
                <div class="p-4 text-left">
                  <div class="row">
                      <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" class="bi bi-arrow-repeat mt-1 mr-3" viewBox="0 0 16 16">
            ...
            <div class="card" >
              <div class="card-body seller-Card" style="overflow-x :hidden">
                <div class="p-4 text-left">
                  <div class="row">
                      <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" class="bi bi-gear-wide mt-1 mr-3" viewBox="0 0 16 16">
                      ...
                      <div class="col">
                        <h5><b>Technical Troubleshooting</b></h5>
                      </div>
                  </div>
            ...
            <div class="card" >
              <div class="card-body seller-Card" style="overflow-x :hidden">
                <div class="p-4 text-left">
                  <div class="row">
                      <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" class="bi bi-calendar-event mt-1 mr-3" viewBox="0 0 16 16">
                        <path d="M11 6.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1z"/>
                        <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
                        </svg>
                      </div>
                      <div class="col">
                        <h5><b>Billing & Membership Management</b></h5>
                      </div>
                  </div>
          ...
          <div class="col m-2">
            <div class="card" >
              <div class="card-body seller-Card" style="overflow-x :hidden">
                <div class="p-4 text-left">
                  <div class="row">
                    <svg xmlns="http://www.w3.org/2000/svg"  width="30" height="30" fill="blue" class="bi bi-question-lg mt-1 mr-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4.475 5.458c-.284 0-.514-.237-.47-.517C4.28 3.24 5.576 2 7.825 2c2.25 0 3.767 1.36 3.767 3.215 0 1.344-.665 2.288-1.79 2.973-1.1.659-1.414 1.118-1.414 2.01v.03a.5.5 0 0 1-.5.5h-.77a.5.5 0 0 1-.5-.495l-.003-.2c-.043-1.221.477-2.001 1.645-2.712 1.03-.632 1.397-1.135 1.397-2.028 0-.979-.758-1.698-1.926-1.698-1.009 0-1.71.529-1.938 1.402-.066.254-.278.461-.54.461h-.777ZM7.496 14c.622 0 1.095-.474 1.095-1.09 0-.618-.473-1.092-1.095-1.092-.606 0-1.087.474-1.087 1.091S6.89 14 7.496 14Z"/>
                    </svg>
                    <h5 class="mt-2"><b>Miscellaneous</b></h5>
                  </div>
