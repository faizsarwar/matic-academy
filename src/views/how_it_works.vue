    ...
    <section class="pt-5 pb-5" style="background-color: #A2469A;color:white">
      <div class="row mt-4 mb-4 ml-4 mr-3 text-left">
        <div class="col-lg">
          ...
          <ul class="">
            <li>
                High-quality instructors from top US universities
            </li>
            <li>
                A project-based approach to learning
            </li>
            <li>
                An intuitive learning platform with key parental tools
            </li>
            <li>
                A tight-knit community of like-minded learners
            </li>
            <li>
                And an expert-backed curriculum team
            </li>
          </ul>
            <div class="row mt-1">
              <div class="col-8">
    ...
    <div class="mt-2 mb-2">
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg " style=" text-align: center; color: black;">
          <ul class="text-left pt-0 ml-5" style="color:#261159">
              <li>
                  Manage Your Matic Account & Courses
              </li>
              <li>
                  View Progress Tracking
              </li>
              <li>
                  Access Student Support & Advisors
              </li>
              <li>
                  Join Office Hours & Live Help
              </li>
              <li>
                   Attend Matic Clubs
              </li>
              <li>
                   Explore and Share Matic Projects
              </li>
              <li>
                   Discover Learning Paths & Concentrations
              </li>
              <li>
