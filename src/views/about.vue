<template>
    ...
    <section class="pt-5 pb-5" style="background-color: #3a0078;color:white">
      <div class="row mt-4 mb-4 ml-4 mr-3 text-left p-5">
        ...
        <div class="p-5">
            <h5 class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-2"><b >OUR MISSION</b></h5>
            <div class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-2">
                               <h1><b>     To empower kids to discover their best futures </b> by  providing expert mentorship, strong community, and a joyful learning experience.</h1>
    ...
    <section>
        ...
        <div class="p-5 row text-left">
            ...
            <div class="col p-3">
                ...
                <br>
                <p>But it wasn’t always easy to pursue that curiosity. Ruby’s high school didn’t offer computer science, so she had find ways to self-learn it online. Unsurprisingly, business and nonprofit work also weren’t subjects offered at Vivian’s school. And when she wanted to try the limited coding classes her school did have, she was intimidated by the shortage of beginners and girls in the class.</p>
            </div>
            <div class="col p-3">
