<template>
          ...
          <p class="mt-5 ml-4 pr-5" style=" color:white">
           <span class="px-4 py-2  mb-2" style="border-radius: 9px; color: white;  background-color:#4CBD94;">  Age 8-18</span>
            ...
            <p class="ml-4 pr-5 mt-3" style="color:white !important">Unlimited access to Matic's 400+ hours
                ...
                with live instructor support included!
            </p>
            ...
            <div class="row">
                <div class="col-8 " style=" text-align: left; color: black;">
                    <div class=" ml-5 pt-5 pr-5 pl-5 ">
                        <h1 class="mt-3 mb-3"><b>Unlimited Learning. Only $29/Month</b></h1>
                        <!-- row with tick -->
                        <div class="row">
                            <div class="col-1 ">
                                <!-- svg -->
                            ...
                            <div class="col-8 text-left">
                                <p>Full access to over <b>400+</b> hours of on demand courses, with new courses added each month!</p>
                            </div>
                        </div>
                        <!-- row with tick -->
                        <div class="row">
                            ...
                            <div class="col-8 text-left">
                                <p>
                                   <b>Video-led </b>, project-based curriculum, paired with hands-on activities and projects.</p>
                            </div>
                        </div>
                        <!-- row with tick -->
                        <div class="row">
                            ...
                            <div class="col-8 text-left">
                                <p><b>Unlimited access to daily office hours </b> hosted by instructors handpicked from top U.S. universities.</p>
                            </div>
                        </div>
                        <!-- row with tick -->
                        <div class="row">
                            ...
                            <div class="col-8 text-left">
                                <p>Access to a<b> community of like-minded learners </b>through interest-based clubs and events.</p>
                            </div>
                        </div>
                        <!-- row with tick -->
                        <div class="row">
                            ...
                            <div class="col-8 text-left">
                               <p><b>Weekly progress reports </b>for parents.</p>
                            </div>
                        </div>
                        <!-- row with tick -->
                        <div class="row mt-2">
                            ...
                            <div class="col-8 text-left">
                                <p>A <b>personalized digital portfolio </b>designed to highlight all course accomplishments.</p>
                            </div>
                        </div>
                    </div>
                    
                </div>
                <div class="col-4 pt-5" style=" text-align: center; color: black;">
                  <img src="../assets/img/UnlimitedLearning.jpg" alt="" class=" mt-5" style="background-size:contain;  background-repeat: no-repeat; text-align: center;width:100%; ">
                </div>
            </div>
        </section>
    ...
    <section class="pt-5 pb-5 pl-4 pr-4 text-center">
        <div>
            <h1 class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-2"><b >Unlimited Access for Only $29/Month</b></h1>
            <p class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-2">
            Try our On Demand Subscription for free to access all our self-study courses.
            </p>
            <button
                type=""
    ...
    <div class="row text-left pl-4 pr-3">
      <div class="col-lg " >
        <h3 class="ml-5 mt-5"><b>
          ...
          Call Us</b></h3>
        <h3 class="ml-5 mt-2"><b>+1 (609) 375-0046</b> </h3>
      </div>
      <div class="col-lg" style="font-size:18px">
        ...
        <section class="pt-5 pb-5 pl-4 pr-4 text-center" style="background-color:#f2f8fa">
        <div class="pt-5 pb-5 pl-4 pr-4 text-center">
            <h1 class="pl-5 pr-5 ml-5 mr-5 pb-5 mb-2"><b >On-Demand Not Right For You?</b></h1>
